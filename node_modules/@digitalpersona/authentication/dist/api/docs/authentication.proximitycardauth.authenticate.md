...
[Home](./index.md) &gt; [@digitalpersona/authentication](./authentication.md) &gt; [ProximityCardAuth](./authentication.proximitycardauth.md) &gt; [authenticate](./authentication.proximitycardauth.authenticate.md)

## ProximityCardAuth.authenticate() method
...
a promise to return a JSON Web Token containing a claim (`crd`<!-- -->) showing the fact a proximity card was used. Will reject if authentication fails.
